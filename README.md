...
Move into the root directory and build there; executables go into `bin/`.
...
4. ✅ **Intermediate representation** – convert AST to IR (e.g. three-address
...
6. ✅ **Code generation** – emit target code (assembly, bytecode, etc.).
